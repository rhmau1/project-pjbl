        ...
        <div class="col-lg-4 centered">
          <div class="card-body mt-4">
            <div class="card-body text-center">
              ...
              <h5 class="my-3" style="font-size: 25px;">Fijriati Rahma</h5>
              <p class="text-muted mb-1" style="font-size: 20px;">@rahma</p>                           
            </div>
          </div>          
          </div>
        </div>
          ...
          <div class="card mb-4">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-sm-9">
                  <p class="text-muted mb-0" style="font-size: 20px;">Fijriati Rahma</p>  
              ...
              <div class="row">
                ...
                <div class="col-sm-9">
                  <p class="text-muted mb-0" style="font-size: 20px;">@Rahma</p>  
                  <a href="./edit_profil.php" class="btn btn-primary pull-right">Edit</a>                
                </div>                                
              </div>              
              <hr>
              <div class="row">
                ...
                <div class="col-sm-9">
                  <p class="text-muted mb-0" style="font-size: 20px;">rahma@gmail.com</p>
                  <a href="./edit_profil.php" class="btn btn-primary pull-right">Edit</a>
                </div>
              </div>
              <hr>
              <div class="row">
                ...
                <div class="col-sm-9">
                  <p class="text-muted mb-0" style="font-size: 20px;">085791243799</p>
                  <a href="./edit_profil.php" class="btn btn-primary pull-right">Edit</a>
                </div>
              </div>
            </div>
