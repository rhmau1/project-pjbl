        ...
        <div class="row property__gallery">
            <div class="col-lg-3 col-md-4 col-sm-6 mix women">
                <div class="product__item">
                    <a href="./detail_produk_user.php">
                        <div class="product__item__pic set-bg" data-setbg="img/formal.jpg">
                        </div>
                    </a>                                        
                    <div class="product__item__text">
                        <h6><a href="./detail_produk_user.php">Buttons tweed blazer</a></h6>
                        <div class="rating">
                            <i><a href="./keranjang.php"><span class="icon_bag_alt"></span></a></i>                            
                        </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix cosmetic">
                <div class="product__item">
                    <a href="./detail_produk_user.php">
                        <div class="product__item__pic set-bg" data-setbg="img/formal3.jpg">
                        </div>
                    </a>                                        
                    <div class="product__item__text">
                        <h6><a href="./detail_produk_user.php">Buttons tweed blazer</a></h6>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
                <div class="product__item">
                    <a href="./detail_produk_user.php">
                        <div class="product__item__pic set-bg" data-setbg="img/formal5.jpg">
                        </div>
                    </a>                                        
                    <div class="product__item__text">
                        <h6><a href="./detail_produk_user.php">Buttons tweed blazer</a></h6>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
                <div class="product__item">
                    <a href="./keranjang.php">
                        <div class="product__item__pic set-bg" data-setbg="img/formal6.jpg">
                        </div>
                    </a>                                        
                    <div class="product__item__text">
                        <h6><a href="./detail_produk_user.php">Buttons tweed blazer</a></h6>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-4 col-sm-6">
                <div class="trend__content">
                    <div class="section-title">
                        <h4>Seragam Olahraga</h4>
                    </div>
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="img/olahraga.jpg" alt="">
                        </div>
                        <div class="trend__item__text">
                            <h6>Seragam Olahraga</h6>                            
                            <div class="product__price">Rp. 50.000</div>
                        </div>
                    </div>
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="img/olahraga1.png" alt="">
                        </div>
                        <div class="trend__item__text">
                            <h6>Seragam Olahraga</h6>                            
                            <div class="product__price">Rp. 50.000</div>
